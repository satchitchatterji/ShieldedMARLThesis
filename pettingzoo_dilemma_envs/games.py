...
class Prisoners_Dilemma(Game):
    ...
    def __init__(self):
        ...
        self.coop = 4 # cooperate-cooperate payoff
        self.defect = 1  # defect-defect payoff
        self.temptation = 10  # cooperate-defect (or vice-versa) tempation payoff
...
class Stag_Hunt(Game):
    ...
    def __init__(self):
        ...
        self.payoff = {
            ...
            (self.STAG, self.HARE): (-1, 2),
            (self.HARE, self.STAG): (2, -1),
...
class Chicken(Game):
    ...
    def __init__(self):
        ...
        self.payoff = {
            ...
            (self.STRAIGHT, self.STRAIGHT): (-10, -10),
        }
