...
% transition
sensor_position_right(X) :- sensor_position(X), X > 29.               % 30, 31, 0, 1, 2
sensor_position_right(X) :- sensor_position(X), X < 3.              
sensor_position_up_right(X) :- sensor_position(X), X > 1, X < 7.      % 2, 3, 4, 5, 6
sensor_position_up(X) :- sensor_position(X), X < 11, X > 5.           % 6, 7, 8, 9, 10
sensor_position_up_left(X) :- sensor_position(X), X > 9, X < 15.      % 10, 11, 12, 13, 14
sensor_position_left(X) :- sensor_position(X), X > 13, X < 19.        % 14, 15, 16, 17, 18
sensor_position_down_left(X) :- sensor_position(X), X > 17, X < 23.   % 18, 19, 20, 21, 22
sensor_position_down(X) :- sensor_position(X), X > 21, X < 27.        % 22, 23, 24, 25, 26
sensor_position_down_right(X) :- sensor_position(X), X > 25, X < 31.  % 26, 27, 28, 29, 30
...
go_away_from_poison :- action(up), poison(X), sensor_position_down_right(X), sensor_position(X).
